package teste.dynaccurate.microBlogPessoal.configuration;
...
.basePackage("teste.dynaccurate.microBlogPessoal.controller"))
...
.description("Projeto API Spring Dynaccurate - Micro Blog Pessoal do Thiagão")
.version("1.0.0")
